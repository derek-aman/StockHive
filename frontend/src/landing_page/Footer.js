...
<div className='row mt-5'>
      <div className='col '><a href=""style={{textDecoration:"none"}}>NSE</a></div>
      <div className='col'><a href=""style={{textDecoration:"none"}}>BSE </a></div>
      <div className='col'><a href=""style={{textDecoration:"none"}}>MCX</a></div>
      <div className='col'><a href=""style={{textDecoration:"none"}}>Terms & conditions</a></div>
      <div className='col'><a href=""style={{textDecoration:"none"}}>Policies & procedures</a></div>
      <div className='col'><a href=""style={{textDecoration:"none"}}>Privacy policy </a></div>
      <div className='col'><a href=""style={{textDecoration:"none"}}>Disclosure</a></div>
      <div className='col'><a href=""style={{textDecoration:"none"}}>For investor's</a></div>
      <div className='col'><a href=""style={{textDecoration:"none"}}>attention</a></div>
      <div className='col'><a href=""style={{textDecoration:"none"}}>Investor charter</a></div>
      </div>
       </div>
